...
export function AdminProductCreate() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!storage) {
      toast.error('Firebase Storage tidak aktif. Silakan gunakan opsi input URL Gambar.');
      return;
    }
    ...
    try {
      ...
      toast.error('Gagal mengunggah gambar. Pastikan Storage Rules diizinkan.');
    } finally {
      setUploading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const finalProduct = {
        ...
        price: numPrice,
        stock: numStock,
        image: imageUrl.trim() || 'https://placehold.co/600x400?text=No+Image',
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-extrabold text-white">Tambah Produk Baru</h1>
      </div>
